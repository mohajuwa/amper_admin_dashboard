            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-info">
                        ...
                        <!-- Form -->
                        <form id="editCustomerForm" action="{{ route('admin.customer.update', $getRecord->user_id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="full_name" value="{{ old('full_name', $getRecord->full_name) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                                id="phone" name="phone" value="{{ old('phone', $getRecord->phone) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('verfiycode', $getRecord->verfiycode) }}"
                                            ...
                                            <small class="form-text text-muted">
                                                ...
                                                إذا أردت تغييره، أدخله هنا (4 أرقام)
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror"
                                                ...
                                                <option value="banned"
                                                    {{ old('status', $getRecord->status) == 'banned' ? 'selected' : '' }}>
                                                    محظور
                                                </option>
                                            </select>
                                            @error('status')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('approve') is-invalid @enderror"
                                                ...
                                                <option value="0"
                                                    {{ old('approve', $getRecord->approve) == 0 ? 'selected' : '' }}>
                                                    غير موافق
                                                </option>
                                                <option value="1"
                                                    {{ old('approve', $getRecord->approve) == 1 ? 'selected' : '' }}>
                                                    موافق
                                                </option>
                                            </select>
                                            @error('approve')
                                    ...
                                    <div class="col-12">
                                        <div class="info-box bg-light">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text">معلومات العميل</span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <button type="submit" class="btn btn-primary btn-lg" id="submitBtn">
                                            ...
                                            <span class="btn-text">تحديث العميل</span>
                                        </button>
                                    </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $('body').on('submit', '#editCustomerForm', function(e) {
            e.preventDefault();
            const $form = $(this);
