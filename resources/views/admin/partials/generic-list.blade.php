{{-- resources/views/admin/partials/generic-list.blade.php --}}
<div class="container-fluid">
    {{-- Page Header --}}
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">{{ $pageConfig['title'] }}</h4>
                <div class="page-title-right">
                    @if(isset($pageConfig['createRoute']))
                        <a href="{{ $pageConfig['createRoute'] }}" class="btn btn-primary">
                            <i class="fas fa-plus"></i> {{ $pageConfig['createButtonText'] ?? 'إضافة جديد' }}
                        </a>
                    @endif
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ $tableConfig['title'] ?? $pageConfig['title'] }}</h3>
                </div>
                <div class="card-body">
                    @if ($records->count() > 0)
                        {{-- Desktop Table --}}
