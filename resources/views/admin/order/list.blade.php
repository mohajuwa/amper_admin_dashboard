                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                                        ...
                                        <select name="payment_method" class="form-control">
                                            ...
                                            <option value="0"
                                                {{ Request::get('payment_method') == '0' ? 'selected' : '' }}>نقداً</option>
                                            <option value="1"
                                                {{ Request::get('payment_method') == '1' ? 'selected' : '' }}>بطاقة ائتمان
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                                        ...
                                        <select name="order_status" class="form-control">
                                            ...
                                            <option value="0"
                                                {{ Request::get('order_status') == '0' ? 'selected' : '' }}>قيد الانتظار
                                            </option>
                                            <option value="1"
                                                {{ Request::get('order_status') == '1' ? 'selected' : '' }}>قيد التنفيذ
                                            </option>
                                            <option value="2"
                                                {{ Request::get('order_status') == '2' ? 'selected' : '' }}>تم التسليم
                                            </option>
                                            <option value="4"
                                                {{ Request::get('order_status') == '4' ? 'selected' : '' }}>مكتمل</option>
                                            <option value="5"
                                                {{ Request::get('order_status') == '5' ? 'selected' : '' }}>ملغي</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    ...
                                    <div
                                        class="col-lg-1 col-md-4 col-sm-6 col-4 d-flex m-2 align-items-center justify-content-center">
                                        <div class="form-group w-100">
                                            <button class="btn btn-info btn-block mb-2">
                                                <i class="fas fa-search"></i>
                                            </button>
                                            <a href="{{ route('admin.order.list') }}" class="btn btn-info btn-block">
                                    ...
                                    <tbody>
                                        @foreach ($getRecord as $value)
                                            <tr>
                                                ...
                                                {{-- CORRECTED LINE: Directly use the model's accessor. No more json_decode(). --}}
                                                <td>{{ optional($value->vendor)->vendor_name_ar ?? 'غير متوفر' }}</td>
                                                ...
                                                <td>
                                                    <div class="text-sm">
                                                        <div class="font-weight-bold">
                                                            {{ \Carbon\Carbon::parse($value->order_date)->locale('ar')->translatedFormat('j F Y') }}
                                                        </div>
                                                        <div class="text-muted">
                                                            {{ \Carbon\Carbon::parse($value->order_date)->format('g:i A') }}
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    @php
                                                        $statuses = [
                                                            ...
                                                            6 => ['label' => 'مجدول', 'class' => 'badge badge-dark'],
                                                        ];
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="status-badge {{ $status['class'] }}">{{ $status['label'] }}</span>
                                                </td>
