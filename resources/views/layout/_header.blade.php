        ...
        <div class="header-middle sticky-header">
            <div class="container">
                ...
                <div class="header-right">
                    ...
                    if (Auth::check()) {
                        $getUnreadNotifications = App\Models\NotificationModel::getUnreadNotificationsUser(Auth::user()->id);
                    }
                @endphp
                ...
                <div class="dropdown cart-dropdown">
                    <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown"
                        ...
                        <span class="cart-count">
                            {{ is_countable($getUnreadNotifications) ? $getUnreadNotifications->count() : 0 }}
                        </span>
                    </a>
                
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        @if (is_countable($getUnreadNotifications) && $getUnreadNotifications->count() > 0)
                            ...
                            @foreach ($getUnreadNotifications as $noti)
                                ...
                                <a href="{{ url($noti->url) }}?noti_id={{ $noti->id }}" class="dropdown-item">
                                    ...
                                    <div class="text-muted text-sm">
                                        {{ date('d-m-Y h:i A', strtotime($noti->created_at)) }}
                                    </div>
                                </a>
                                <div class="dropdown-divider"></div>
                            @endforeach
