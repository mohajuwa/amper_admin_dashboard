<aside class="col-md-4 col-lg-3">
    <ul class="nav nav-dashboard flex-column mb-3 mb-md-0" role="tablist">
        ...
        @php
        $getUnreadNotifications = App\Models\NotificationModel::getUnreadNotificationsUserCount(Auth::user()->id);
        @endphp
        <li class="nav-item">
            <a class="nav-link @if (Request::segment(2) == 'notifications') active @endif "
                href="{{ url('user/notifications') }}">Notifications ({{$getUnreadNotifications}})</a>
        </li>
        <li class="nav-item">
