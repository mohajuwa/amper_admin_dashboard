...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may define how the users are actually retrieved out of your
    ...
    */
    ...
    'passwords' => [
        ...
        'admins' => [ // ← Optional: Add this if you want password reset for admins
            'provider' => 'admins',
            'table' => 'password_reset_tokens',
            'expire' => 60,
            'throttle' => 60,
    ...
    | confirmation screen. By default, this lasts for three hours.
    |
    */
